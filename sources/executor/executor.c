...
/*   Updated: 2023/07/06 15:20:38 by szerisen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
It iterates through the list by following the prev 
pointers until it reaches the first node (where map->prev is NULL).
